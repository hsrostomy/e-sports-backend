	...
	var dzMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#2D28FF', 'rgb(0, 122, 100)', '#1bd084'],
				//responsive:true,
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(0, 122, 100)', 'rgb(27, 208, 132)', '#2D28FF'],
				resize: true
		...
		var barChart = function(){
			...
			Morris.Bar({
				...
				ykeys: ['a', 'b', 'c'],
				labels: ['A', 'B', 'C'],
				barColors: ['#162490', '#1bd084', '#ff9f00'],
				hideHover: 'auto',
				gridLineColor: 'transparent',
				resize: true,
				barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#2D28FF', 'rgb(16, 202, 147)', 'rgb(0, 122, 100)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
